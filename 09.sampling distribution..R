...
#표본의 크 기2로 추출된 데이터의 평균을 구 한 뒤 막대그래프 작성
...
#sample size=2
data50=c(1:50)#데이터
com2=combn(data50, 2)#데이터에서 2개씩 선택하며 데이터 생성
com2t=t(com2)#데 이터의 전치
z2=rowMeans(com2t)#전치된 데이터의 행평균 계산
meanofz2=mean(z2)#기 댓값을 계산하여 저장
print(meanofz2)
...
meanofz5=mean(z5)
print(meanofz5)
barplot(table(z5),xlab="평균3",ylab="도수",main="표본크기5의도수분포포")
